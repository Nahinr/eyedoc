        ...
        <div class="bg-white rounded shadow-lg p-4 px-4 md:p-8 mb-6">
          <div class="grid gap-4 gap-y-2 text-sm grid-cols-1 lg:grid-cols-3">
            <div class="text-gray-600">
              <p class="font-medium text-lg">Historial Clinico</p>
            ...
            <div class="lg:col-span-2">
              <div class="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-5">
                ...
                <div class="md:col-span-3">
                  <label for="address">Identidad</label>
                ...
                <div class="md:col-span-1">
                  <label for="zipcode">Teléfono</label>
                ...
                <div class="md:col-span-5 mt-7 text-right">
                  <div class="inline-flex items-end">
                    <button class="text-white bg-cyan-600 hover:bg-cyan-700 focus:ring-4 focus:ring-cyan-200 font-bold py-2 px-4 rounded">Agregar</button>
                  </div>
                </div>
